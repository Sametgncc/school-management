...
public class AuthenticationController {
    ...
    @PostMapping("/login") // http://localehost:8080/auth/login + POST + JSON
    public ResponseEntity<AuthResponse> authenticaUser(@RequestBody @Valid LoginRequest loginRequest){
