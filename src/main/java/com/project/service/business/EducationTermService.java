...
public class EducationTermService {
    ...
    public List<EducationTermResponse> getAllEducationTerms() {
        return educationTermRepository.findAll()
                .stream()
                .map(educationTermMapper::mapEducationTermToEducationTermResponse) // POJO --> DTO
    ...
    public ResponseMessage<EducationTermResponse> updateEducationTerm(Long id, @Valid EducationTermRequest educationTermRequest) {
        isEducationTermExist(id);
